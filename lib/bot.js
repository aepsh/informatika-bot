...
var replyMessage = function replyMessage(message, text, res) {
	...
	recastaiReq.analyseText(content).then(function (recastaiRes) {
		...
		if (recastaiRes.entities.hasOwnProperty('menu')) {
			...
			request('http://tipolindrachatbot.000webhostapp.com/api/v1/informasi/jadwal', function (_err, _res, body) {
			...
			request('http://tipolindrachatbot.000webhostapp.com/api/v1/informasi/kurikulum', function (_err, _res, body) {
			...
			request('http://tipolindrachatbot.000webhostapp.com/api/v1/informasi/struktur', function (_err, _res, body) {
			...
			request('http://tipolindrachatbot.000webhostapp.com/api/v1/informasi/pendaftaran', function (_err, _res, body) {
			...
			request('http://tipolindrachatbot.000webhostapp.com/api/v1/informasi/lab', function (_err, _res, body) {
			...
			request('http://tipolindrachatbot.000webhostapp.com/api/v1/informasi/dosen', function (_err, _res, body) {
